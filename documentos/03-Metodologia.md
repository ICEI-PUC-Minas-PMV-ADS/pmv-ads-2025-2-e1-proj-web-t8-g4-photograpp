...
Este documento descreve a metodologia de desenvolvimento adotada para o projeto Photograpp – Sistema para Fotógrafos, utilizando a metodologia ágil Scrum. O objetivo é garantir previsibilidade nas entregas, qualidade e alinhamento contínuo com os requisitos funcionais (RF) e não funcionais (RNF) do produto.

O SCRUM foi escolhido para o desenvolvimento deste projeto, pois como citam Amaral, Fleury e Isoni (2019, p. 68), seus benefícios são a
